...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        ...
        else if (NotificationPreferenceFragment.class.getName().equals(fragmentName)) return true;
        else if (DataSyncPreferenceFragment.class.getName().equals(fragmentName)) return true;
        else return false;
    }
